...
namespace TinyRenderer
{
	...
	public:
		...
		TRSpotLight(glm::vec3 pos, glm::vec3 atten, glm::vec3  dir , glm::vec3 color , float cutOff , float outerCutOff)
			: lightPos(pos), attenuation(atten),direction(dir), lightColor(color) , cutOff(cutOff) , outerCutOff(outerCutOff){}
	};
}
